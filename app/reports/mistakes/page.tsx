    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      <div className="border-b border-slate-800 pb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">XAUUSD Gold Mistake Leakage</h1>
      ...
      <div className="glass-card rounded-2xl p-6 border border-rose-500/30 bg-rose-950/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="text-3xl font-bold text-rose-400 font-mono tracking-tight mt-1">
