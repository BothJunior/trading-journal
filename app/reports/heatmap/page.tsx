    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      <div className="border-b border-slate-800 pb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Time & Day Distribution Heatmap</h1>
            ...
            <div className="space-y-3">
              {data?.byDay?.map((item: any) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <span className="w-10 font-bold text-white text-sm">{item.day}</span>
                      <span className="text-xs text-slate-400">({item.totalTrades} trades)</span>
                    </div>

                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        <div className="text-xs text-slate-400 font-medium">Win Rate</div>
                        <div className="text-sm font-bold text-cyan-400">{item.winRate.toFixed(1)}%</div>
                      </div>

                      <div className="text-right w-24">
                        <div className="text-xs text-slate-400 font-medium">Net PnL</div>
                        <div
